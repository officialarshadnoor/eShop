     ...
     <button className='bg-[#56d879] hover:bg-teal-500 duration-300 px-5 py-2.5 rounded-md text-white md:w-auto w-full'>Submit</button>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-4 gap-6 sm:px-8 px-5 py-16 sm:text-center">
        ...
        <div className="flex items-center mt-[15px]">
            <AiOutlineFacebook size={25} style={{marginLeft: "15px", cursor: "pointer"}}/>
            <AiOutlineTwitter size={25} style={{marginLeft: "15px", cursor: "pointer"}}/>
            <AiOutlineInstagram size={25} style={{marginLeft: "15px", cursor: "pointer"}}/>
            <AiOutlineYoutube size={25} style={{marginLeft: "15px", cursor: "pointer"}}/>
        </div>
        </ul>
...
<span>2020 Piemond. All rights reserved.</span>
<span>Terms  Privary Policy</span>
<div className='sm:block flex items-center justify-center w-full'>
<img src="https://cdn.webshopapp.com/shops/218525/files/371942398/payment-methods-epicerie-ludo.png" alt="" className='' />
</div>
</div>
    </div>
  )
