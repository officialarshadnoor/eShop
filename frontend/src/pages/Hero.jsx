    ...
    <div className={`relative min-h-[70vh] 800px:min-h-[80vh] w-full bg-no-repeat ${styles.normalFlex}`} style={{
      ...
      <div className={`${styles.section} w-[90%] 800px:w-[60%]`}>
        ...
        <p className='pt-5 text-[16px] font-[Poppins] font-[400] text-[#000000ba]'>
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Incidunt excepturi numquam repellat ad? Sequi, obcaecati! Est architecto ratione iure perferendis?
        </p>
        <Link to="/products">
