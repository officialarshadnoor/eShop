const styles = {
    ...
    productTitle: 'text-[25px] text-[600] font-Roboto text-[#333]',
    productDiscountPrice: 'font-bold text-[18px] text-[#333] font-Roboto',
    price: 'font-[500] text-[16px] text-[#d55b45] pl-3 mt-[-rpx] line-throght',
    shop_name: 'pt-3 text-[19px] text-blue-400 pb-3',
